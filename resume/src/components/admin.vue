    ...
    <span id="box1">
      ...
      <span id="user_show_body">
        <el-menu
          ...
          text-color="black"
        >
          <el-menu-item index="/adminCharge">审批简历</el-menu-item>
          <el-menu-item index="/adminSelfdata">个人信息</el-menu-item>
          <el-menu-item index="/adminFormCharge">简历模板</el-menu-item>
...
export default {
  ...
  methods:{
    logout:function(){
      ...
      localStorage.setItem('adminBelong','')
